	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := d.Sub(tt.args.r); !got.Equals(tt.want, EpsFp32) {
				t.Errorf("Series.Sub() = %v, want %v", got, tt.want)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := d.Mul(tt.args.r); !got.Equals(tt.want, EpsFp32) {
				t.Errorf("Series.Mul() = %v, want %v", got, tt.want)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := d.Div(tt.args.r); !got.Equals(tt.want, EpsFp32) {
				t.Errorf("Series.Div() = %v, want %v", got, tt.want)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := d.AddScalar(tt.args.s); !got.Equals(tt.want, EpsFp32) {
				t.Errorf("Series.AddScalar() = %v, want %v", got, tt.want)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := d.SubScalar(tt.args.s); !got.Equals(tt.want, EpsFp32) {
				t.Errorf("Series.SubScalar() = %v, want %v", got, tt.want)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := d.MulScalar(tt.args.s); !got.Equals(tt.want, EpsFp32) {
				t.Errorf("Series.MulScalar() = %v, want %v", got, tt.want)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := d.DivScalar(tt.args.s); !got.Equals(tt.want, EpsFp32) {
				t.Errorf("Series.DivScalar() = %v, want %v", got, tt.want)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := d.Fillna(tt.args.value); !got.Equals(tt.want, EpsFp32) {
				t.Errorf("Series.Fillna() = %v, want %v", got, tt.want)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if !tt.want.Equals(d, EpsFp32) {
				t.Fatalf("Series.Pad() = %v, want %v", d.values, tt.want.values)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if len(d.values) != len(tt.want.values) {
				t.Fatalf("Series.Sort() = %v, want %v", d.values, tt.want.values)
			}
...
func TestData_SortStable(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if len(d.values) != len(tt.want.values) {
				t.Fatalf("Series.SortStable() = %v, want %v", d.values, tt.want.values)
			}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if !d.Equals(tt.want, EpsFp32) {
				t.Fatalf("Series.IndexSort() = %v, want %v", d.values, tt.want.values)
			}
		})
	}
}
...
func TestData_IndexSortStable(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if !d.Equals(tt.want, EpsFp32) {
				t.Fatalf("Series.IndexSortStable() = %v, want %v", d.values, tt.want.values)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := d.Reverse(); !got.Equals(tt.want, EpsFp32) {
				t.Errorf("Series.Reverse() = %v, want %v", got, tt.want)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := d.Diff(tt.args.period); !got.Equals(tt.want, EpsFp32) {
				t.Errorf("Series.Diff() = %v, want %v", got, tt.want)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := d.Resize(tt.args.newLen); !got.Equals(tt.want, EpsFp32) {
				t.Errorf("Series.Resize() = %v, want %v", got, tt.want)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := d.Equals(tt.args.r, tt.args.eps); got != tt.want {
				t.Errorf("Series.DataEqual() = %v, want %v", got, tt.want)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := d.Lerp(); !got.Equals(tt.want, EpsFp32) {
				t.Errorf("Series.Lerp() = %v, want %v", got, tt.want)
			}
		})
	}
}
