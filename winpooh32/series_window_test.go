	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := w.Sum(); !got.Equals(tt.want, EpsFp32) {
				t.Errorf("BaseWindow.Sum() = %v, want %v", got, tt.want)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := w.Mean(); !got.Equals(tt.want, EpsFp32) {
				t.Errorf("BaseWindow.Mean() = %v, want %v", got, tt.want)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := w.Min(); !got.Equals(tt.want, EpsFp32) {
				t.Errorf("BaseWindow.Min() = %v, want %v", got, tt.want)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := w.Max(); !got.Equals(tt.want, EpsFp32) {
				t.Errorf("BaseWindow.Max() = %v, want %v", got, tt.want)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := w.Std(ma, 1); !got.Equals(tt.want, EpsFp32) {
				t.Errorf("BaseWindow.Std() = %v, want %v", got, tt.want)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := w.Skew(tt.fields.data); !got.Equals(tt.want, 1e-4) {
				t.Errorf("BaseWindow.Skew() = %v, want %v", got, tt.want)
			}
		})
	}
}
