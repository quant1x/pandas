...
import "gitee.com/quant1x/pandas/winpooh32/vek"

// IndexAsInt32 returns copy of underlying index slice converted to int32 array.
func (d Series) IndexAsInt32() (index []int32) {
...
func (d Series) IndexAsFloat32() (index []float32) {
...
func (d Series) IndexAsFloat64() (index []float64) {
...
func (d Series) ValuesAsInt32() (values []int32) {
...
func (d Series) ValuesAsInt64() (values []int64) {
...
func (d Series) ValuesAsFloat32() (values []float32) {
	switch {
	case EnabledAVX2:
...
func (d Series) ValuesAsFloat64() (values []float64) {
	switch {
	case EnabledAVX2:
