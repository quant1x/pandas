...
type Array interface {
	...
	// IsSlice return true when obj is slice
	IsSlice() bool

	// Join array join into string
	// eg
	...
	// SortMT sort by quick multithreading
	...
	// Any Determines whether the Array contains any elements
	Any(express interface{}) bool

	// All Determines whether the condition is satisfied for all elements in the Array
	All(express interface{}) bool

	// Count Returns a number indicating how many elements in the specified Array satisfy the condition
	Count(express interface{}) int

	// First Returns the first element of an Array that satisfies the condition
	First(express interface{}) (interface{}, error)

	// Last Returns the last element of an Array that satisfies the condition
	Last(express interface{}) (interface{}, error)

	// Index Returns the zero based index of the first occurrence in an Array
	Index(i int) (interface{}, error)

	// Take skip and Returns the elements
	Take(skip, count int) Array

	// Sum sum of the values returned by the expression
	Sum(express interface{}) interface{}

	// Average average of the values returned by the expression
	Average(express interface{}) float64

	// Contains Determines whether the array contains the specified element
	// number type use default comparator
	// other type can implements Compare
	Contains(express interface{}) bool

	// Pointer array or slice pointer
